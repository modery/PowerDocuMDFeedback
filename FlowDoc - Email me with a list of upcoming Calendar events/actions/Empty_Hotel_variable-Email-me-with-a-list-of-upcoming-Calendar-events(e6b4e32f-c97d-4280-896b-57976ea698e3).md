...
## Empty\_Hotel\_variable

| Property | Value                  |
| -------- | ---------------------- |
| Name     | Empty\_Hotel\_variable |
| Type     | SetVariable            |
...
| Next Action                                                                                                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Empty\_Flight\_variable \[Succeeded\]](Empty_Flight_variable-Email-me-with-a-list-of-upcoming-Calendar-events(e6b4e32f-c97d-4280-896b-57976ea698e3).md) |
